...
public class Cmdb_ITCase {
    ...
    public void cmdb_getInstanceList_1() throws Exception {
        ...
        ResponseEntity<String>  httpResult = request("/nacos/v1/ns/com.yuanxiaoyuan.springcloudalibabafeign.service",
            Params.newParams()
    ...
    public void cmdb_getInstanceList_4() throws Exception {
        ...
        httpResult = request( "/nacos/v1/ns/com.yuanxiaoyuan.springcloudalibabafeign.service",
            Params.newParams()
                .appendParam("serviceName", serviceName)
            ...
            String.class,
            HttpMethod.GET);
        System.out.println("com.yuanxiaoyuan.springcloudalibabafeign.service list = " + JSON.parseObject(httpResult.getBody()));
