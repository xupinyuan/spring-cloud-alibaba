...
public class RestAPI_ITCase {
    ...
    public void createService() throws Exception {
        ...
        ResponseEntity<String> response = request(NamingBase.NAMING_CONTROLLER_PATH + "/com.yuanxiaoyuan.springcloudalibabafeign.service",
            Params.newParams()
    ...
    public void getService() throws Exception {
        ...
        //get com.yuanxiaoyuan.springcloudalibabafeign.service
        response = request(NamingBase.NAMING_CONTROLLER_PATH + "/com.yuanxiaoyuan.springcloudalibabafeign.service",
            Params.newParams()
                .appendParam("serviceName", serviceName)
                .appendParam("protectThreshold", "0.3")
                .done(),
    ...
    public void listService() throws Exception {
        String serviceName = NamingBase.randomDomainName();
        //get com.yuanxiaoyuan.springcloudalibabafeign.service
        ResponseEntity<String> response = request(NamingBase.NAMING_CONTROLLER_PATH + "/com.yuanxiaoyuan.springcloudalibabafeign.service/list",
            Params.newParams()
                .appendParam("serviceName", serviceName)
        ...
        response = request(NamingBase.NAMING_CONTROLLER_PATH + "/com.yuanxiaoyuan.springcloudalibabafeign.service/list",
            Params.newParams()
                .appendParam("serviceName", serviceName)
                .appendParam("pageNo", "1")
                .appendParam("pageSize", "15")
    ...
    public void updateService() throws Exception {
        ...
        //update com.yuanxiaoyuan.springcloudalibabafeign.service
        response = request(NamingBase.NAMING_CONTROLLER_PATH + "/com.yuanxiaoyuan.springcloudalibabafeign.service",
            Params.newParams()
                .appendParam("serviceName", serviceName)
    ...
    private void namingServiceDelete(String serviceName) {
        //delete com.yuanxiaoyuan.springcloudalibabafeign.service
        ResponseEntity<String> response = request(NamingBase.NAMING_CONTROLLER_PATH + "/com.yuanxiaoyuan.springcloudalibabafeign.service",
            Params.newParams()
                .appendParam("serviceName", serviceName)
                .appendParam("protectThreshold", "0.3")
