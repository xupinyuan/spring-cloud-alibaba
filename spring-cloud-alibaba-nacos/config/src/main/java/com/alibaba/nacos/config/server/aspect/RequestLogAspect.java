...
public class RequestLogAspect {
    ...
    private static final String CLIENT_INTERFACE_PUBLISH_SINGLE_CONFIG
        = "execution(* com.alibaba.nacos.config.server.com.yuanxiaoyuan.springcloudalibabafeign.controller.ConfigController.publishConfig(..)) && args"
    ...
    private static final String CLIENT_INTERFACE_GET_CONFIG
        = "execution(* com.alibaba.nacos.config.server.com.yuanxiaoyuan.springcloudalibabafeign.controller.ConfigController.getConfig(..)) && args(request,"
    ...
    private static final String CLIENT_INTERFACE_REMOVE_ALL_CONFIG
        = "execution(* com.alibaba.nacos.config.server.com.yuanxiaoyuan.springcloudalibabafeign.controller.ConfigController.deleteConfig(..)) && args(request,"
        + "response,dataId,group,tenant,..)";
