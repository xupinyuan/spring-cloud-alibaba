...
Nacos (official site: [http://nacos.io](http://nacos.io)) is an easy-to-use platform designed for dynamic com.yuanxiaoyuan.springcloudalibabafeign.service discovery and configuration and com.yuanxiaoyuan.springcloudalibabafeign.service management. It helps you to build cloud native applications and microservices platform easily.

Service is a first-class citizen in Nacos. Nacos supports almost all type of services，for example，[Dubbo/gRPC com.yuanxiaoyuan.springcloudalibabafeign.service](https://nacos.io/en-us/docs/use-nacos-with-dubbo.html)、[Spring Cloud RESTFul com.yuanxiaoyuan.springcloudalibabafeign.service](https://nacos.io/en-us/docs/use-nacos-with-springcloud.html) or [Kubernetes com.yuanxiaoyuan.springcloudalibabafeign.service](https://nacos.io/en-us/docs/use-nacos-with-kubernetes.html).

Nacos provides four major functions.

* **Service Discovery and Service Health Check** 
    
    Nacos makes it simple for services to register themselves and to discover other services via a DNS or HTTP interface. Nacos also provides real-time healthchecks of services to prevent sending requests to unhealthy hosts or com.yuanxiaoyuan.springcloudalibabafeign.service instance.
...
* **Dynamic DNS Service**
   ...
   Nacos supports weighted routing, making it easier for you to implement mid-tier load balancing, flexible routing policies, flow control, and simple DNS resolution services in the production environment within your data center. It helps you to implement DNS-based com.yuanxiaoyuan.springcloudalibabafeign.service discovery easily and prevent applications from coupling to vendor-specific com.yuanxiaoyuan.springcloudalibabafeign.service discovery APIs.

* **Service and MetaData Management**
	
	Nacos provides an easy-to-use com.yuanxiaoyuan.springcloudalibabafeign.service dashboard to help you manage your services metadata, configuration, kubernetes DNS, com.yuanxiaoyuan.springcloudalibabafeign.service health and metrics statistics.
