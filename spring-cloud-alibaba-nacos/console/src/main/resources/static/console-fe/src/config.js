...
module.exports = {
  ...
  'en-us': {
    ...
    disclaimer: {
      title: 'Vision',
      content:
        'By providing an easy-to-use com.yuanxiaoyuan.springcloudalibabafeign.service infrastructure such as dynamic com.yuanxiaoyuan.springcloudalibabafeign.service discovery, com.yuanxiaoyuan.springcloudalibabafeign.service configuration, com.yuanxiaoyuan.springcloudalibabafeign.service sharing and management and etc., Nacos help users better construct, deliver and manage their own com.yuanxiaoyuan.springcloudalibabafeign.service platform, reuse and composite business com.yuanxiaoyuan.springcloudalibabafeign.service faster and deliver value of business innovation more quickly so as to win market for users in the era of cloud native and in all cloud environments, such as private, mixed, or public clouds.',
    },
    documentation: {
      title: 'Documentation',
      list: [
