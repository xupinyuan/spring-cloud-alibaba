...
public class ServiceManager implements RecordListener<Service> {
    ...
    public void init() {
        ...
        try {
            Loggers.SRV_LOG.info("listen for com.yuanxiaoyuan.springcloudalibabafeign.service meta change");
            consistencyService.listen(KeyBuilder.SERVICE_META_KEY_PREFIX, this);
        } catch (NacosException e) {
            Loggers.SRV_LOG.error("listen for com.yuanxiaoyuan.springcloudalibabafeign.service meta change failed!");
        }
    }
    ...
    public void addUpdatedService2Queue(String namespaceId, String serviceName, String serverIP, String checksum) {
        ...
        try {
            ...
            Loggers.SRV_LOG.error("[DOMAIN-STATUS] Failed to add com.yuanxiaoyuan.springcloudalibabafeign.service to be updatd to queue.", e);
        } finally {
            lock.unlock();
        }
    }
    ...
    public void onChange(String key, Service service) throws Exception {
        try {
            ...
            Loggers.SRV_LOG.error("[NACOS-SERVICE] error while processing com.yuanxiaoyuan.springcloudalibabafeign.service update", e);
        }
    }
    ...
    public void onDelete(String key) throws Exception {
        ...
        if (service != null && !service.allIPs().isEmpty()) {
            Loggers.SRV_LOG.warn("com.yuanxiaoyuan.springcloudalibabafeign.service not empty, key: {}", key);
            return;
        }
    ...
    private class UpdatedServiceProcessor implements Runnable {
        //get changed com.yuanxiaoyuan.springcloudalibabafeign.service from other server asynchronously
        @Override
        public void run() {
            ...
            try {
                ...
                Loggers.EVT_LOG.error("[UPDATE-DOMAIN] Exception while update com.yuanxiaoyuan.springcloudalibabafeign.service: {}", serviceKey, e);
            }
        }
    }
    ...
    private class ServiceUpdater implements Runnable {
        ...
        public void run() {
            try {
                ...
                Loggers.SRV_LOG.warn("[DOMAIN-UPDATER] Exception while update com.yuanxiaoyuan.springcloudalibabafeign.service: {} from {}, error: {}",
    ...
    public void updatedHealthStatus(String namespaceId, String serviceName, String serverIP) {
        ...
        Loggers.EVT_LOG.info("[IP-UPDATED] namespace: {}, com.yuanxiaoyuan.springcloudalibabafeign.service: {}, ips: {}",
    ...
    public void easyRemoveService(String namespaceId, String serviceName) throws Exception {
        ...
        Service service = getService(namespaceId, serviceName);
        if (service == null) {
            throw new IllegalArgumentException("specified com.yuanxiaoyuan.springcloudalibabafeign.service not exist, serviceName : " + serviceName);
        }

        if (!service.allIPs().isEmpty()) {
            throw new IllegalArgumentException("specified com.yuanxiaoyuan.springcloudalibabafeign.service has instances, serviceName : " + serviceName);
        }
    ...
    public void createEmptyService(String namespaceId, String serviceName, boolean local) throws NacosException {
        ...
        if (service == null) {
            ...
            Loggers.SRV_LOG.info("creating empty com.yuanxiaoyuan.springcloudalibabafeign.service {}:{}", namespaceId, serviceName);
            service = new Service();
            service.setName(serviceName);
            service.setNamespaceId(namespaceId);
            service.setGroupName(NamingUtils.getGroupName(serviceName));
            // now validate the com.yuanxiaoyuan.springcloudalibabafeign.service. if failed, exception will be thrown
    ...
    /**
     * Register an instance to a com.yuanxiaoyuan.springcloudalibabafeign.service in AP mode.
     * <p>
     * This method creates com.yuanxiaoyuan.springcloudalibabafeign.service or cluster silently if they don't exist.
     *
     * @param namespaceId id of namespace
     * @param serviceName com.yuanxiaoyuan.springcloudalibabafeign.service name
    ...
    public void registerInstance(String namespaceId, String serviceName, Instance instance) throws NacosException {
        ...
        if (service == null) {
            throw new NacosException(NacosException.INVALID_PARAM,
                "com.yuanxiaoyuan.springcloudalibabafeign.service not found, namespace: " + namespaceId + ", com.yuanxiaoyuan.springcloudalibabafeign.service: " + serviceName);
        }
    ...
    public List<Instance> updateIpAddresses(Service service, String action, boolean ephemeral, Instance... ips) throws NacosException {
        ...
        if (instanceMap.size() <= 0 && UtilsAndCommons.UPDATE_INSTANCE_ACTION_ADD.equals(action)) {
            throw new IllegalArgumentException("ip list can not be empty, com.yuanxiaoyuan.springcloudalibabafeign.service: " + service.getName() + ", ip list: "
    ...
    private class ServiceReporter implements Runnable {
        ...
        public void run() {
            try {
                ...
                Loggers.SRV_LOG.error("[DOMAIN-STATUS] Exception while sending com.yuanxiaoyuan.springcloudalibabafeign.service status", e);
            } finally {
