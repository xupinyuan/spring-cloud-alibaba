...
public class ClusterController {
    ...
    public String update(HttpServletRequest request) throws Exception {
        ...
        if (service == null) {
            throw new NacosException(NacosException.INVALID_PARAM, "com.yuanxiaoyuan.springcloudalibabafeign.service not found:" + serviceName);
        }

        Cluster cluster = service.getClusterMap().get(clusterName);
        if (cluster == null) {
            Loggers.SRV_LOG.warn("[UPDATE-CLUSTER] cluster not exist, will create it: {}, com.yuanxiaoyuan.springcloudalibabafeign.service: {}", clusterName, serviceName);
