...
/**
 * Service operation com.yuanxiaoyuan.springcloudalibabafeign.controller
 *
 * @author nkorange
 */
@RestController
@RequestMapping(UtilsAndCommons.NACOS_NAMING_CONTEXT + "/com.yuanxiaoyuan.springcloudalibabafeign.service")
public class ServiceController {
    ...
    public String create(HttpServletRequest request) throws Exception {
        ...
        if (serviceManager.getService(namespaceId, serviceName) != null) {
            throw new IllegalArgumentException("specified com.yuanxiaoyuan.springcloudalibabafeign.service already exists, serviceName : " + serviceName);
        }
        ...
        // now valid the com.yuanxiaoyuan.springcloudalibabafeign.service. if failed, exception will be thrown
    ...
    public String update(HttpServletRequest request) throws Exception {
        ...
        Service service = serviceManager.getService(namespaceId, serviceName);
        if (service == null) {
            throw new NacosException(NacosException.INVALID_PARAM, "com.yuanxiaoyuan.springcloudalibabafeign.service " + serviceName + " not found!");
        }
