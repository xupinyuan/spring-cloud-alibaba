...
public class UtilsAndCommons {
    ...
    public static final String NACOS_NAMING_SERVICE_CONTEXT = "/com.yuanxiaoyuan.springcloudalibabafeign.service";
    ...
    static {
        ...
        SERVICE_SYNCHRONIZATION_EXECUTOR
            ...
            public Thread newThread(Runnable r) {
                ...
                t.setName("nacos.naming.com.yuanxiaoyuan.springcloudalibabafeign.service.worker");
                t.setDaemon(true);
                return t;
            }
        });
        ...
        SERVICE_UPDATE_EXECUTOR
            ...
            public Thread newThread(Runnable r) {
                Thread t = new Thread(r);
                t.setName("nacos.naming.com.yuanxiaoyuan.springcloudalibabafeign.service.update.processor");
                t.setDaemon(true);
                return t;
            }
        });
     ...
     * <p>
     *
     * e.g. Assume there's an array which contains some IP of the servers provide the same com.yuanxiaoyuan.springcloudalibabafeign.service,
