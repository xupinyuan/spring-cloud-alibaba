 ...
 * for a subset of the total com.yuanxiaoyuan.springcloudalibabafeign.service data.
 * <p>
        ...
        if (data.length > 0) {
            ...
            for (Map.Entry<String, Datum<Instances>> entry : datumMap.entrySet()) {
                ...
                if (!listeners.containsKey(entry.getKey())) {
                    // pretty sure the com.yuanxiaoyuan.springcloudalibabafeign.service not exist:
                    if (switchDomain.isDefaultInstanceEphemeral()) {
                        // create empty com.yuanxiaoyuan.springcloudalibabafeign.service
                        Loggers.EPHEMERAL.info("creating com.yuanxiaoyuan.springcloudalibabafeign.service {}", entry.getKey());
