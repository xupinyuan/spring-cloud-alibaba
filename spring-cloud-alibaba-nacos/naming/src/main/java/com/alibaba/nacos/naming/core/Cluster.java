...
public class Cluster extends com.alibaba.nacos.api.naming.pojo.Cluster implements Cloneable {
     ...
     * @param service     the com.yuanxiaoyuan.springcloudalibabafeign.service to which the current cluster belongs
     * @throws IllegalArgumentException the com.yuanxiaoyuan.springcloudalibabafeign.service is null, or the cluster name is null, or the cluster name is illegal
     * @author jifengnan 2019-04-26
     * @since 1.0.1
     */
    ...
    /**
     * Replace the com.yuanxiaoyuan.springcloudalibabafeign.service for the current cluster.
     * <p>Deprecated because the com.yuanxiaoyuan.springcloudalibabafeign.service shouldn't be replaced.
     * (the com.yuanxiaoyuan.springcloudalibabafeign.service fields can be changed, but the com.yuanxiaoyuan.springcloudalibabafeign.service A shouldn't be replaced to com.yuanxiaoyuan.springcloudalibabafeign.service B).
     * If the com.yuanxiaoyuan.springcloudalibabafeign.service of a cluster is required to replace, actually, a new cluster is required.
     *
     * @param service the new com.yuanxiaoyuan.springcloudalibabafeign.service
     */
    @Deprecated
    ...
    /**
     * this method has been deprecated, the com.yuanxiaoyuan.springcloudalibabafeign.service name shouldn't be changed.
     *
     * @param serviceName the com.yuanxiaoyuan.springcloudalibabafeign.service name
     * @author jifengnan  2019-04-26
     * @since 1.0.1
     */
    @Deprecated
    ...
    /**
     * Get the com.yuanxiaoyuan.springcloudalibabafeign.service name of the current cluster.
     * <p>Note that the returned com.yuanxiaoyuan.springcloudalibabafeign.service name is not the name which set by {@link #setServiceName(String)},
     * but the name of the com.yuanxiaoyuan.springcloudalibabafeign.service to which the current cluster belongs.
     *
     * @return the com.yuanxiaoyuan.springcloudalibabafeign.service name of the current cluster.
     */
    @Override
    ...
    public void validate() {
        ...
        Assert.notNull(service, "com.yuanxiaoyuan.springcloudalibabafeign.service cannot be null");
