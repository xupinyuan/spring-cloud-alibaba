...
public class ServiceStatusSynchronizer implements Synchronizer {
    ...
    public void send(final String serverIP, Message msg) {
        ...
        String url = "http://" + serverIP + ":" + RunningConfig.getServerPort() + RunningConfig.getContextPath() +
                UtilsAndCommons.NACOS_NAMING_CONTEXT + "/com.yuanxiaoyuan.springcloudalibabafeign.service/status";
    ...
    public Message get(String serverIP, String key) {
        ...
        String result;
        try {
            Loggers.SRV_LOG.info("[STATUS-SYNCHRONIZE] sync com.yuanxiaoyuan.springcloudalibabafeign.service status from: {}, com.yuanxiaoyuan.springcloudalibabafeign.service: {}", serverIP, key);
            ...
            Loggers.SRV_LOG.warn("[STATUS-SYNCHRONIZE] Failed to get com.yuanxiaoyuan.springcloudalibabafeign.service status from " + serverIP, e);
            return null;
        }
