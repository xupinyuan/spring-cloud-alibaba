...
public class GlobalExecutor {
    ...
    /**
     * thread pool that processes getting com.yuanxiaoyuan.springcloudalibabafeign.service detail from other server asynchronously
     */
    private static ExecutorService serviceUpdateExecutor
        ...
        public Thread newThread(Runnable r) {
            Thread t = new Thread(r);
            t.setName("com.alibaba.nacos.naming.com.yuanxiaoyuan.springcloudalibabafeign.service.update.http.handler");
            t.setDaemon(true);
            return t;
        }
    });
