...
public class CatalogController {
    ...
    @RequestMapping(value = "/com.yuanxiaoyuan.springcloudalibabafeign.service")
    public JSONObject serviceDetail(HttpServletRequest request) throws Exception {
        ...
        if (detailedService == null) {
            throw new NacosException(NacosException.NOT_FOUND, "com.yuanxiaoyuan.springcloudalibabafeign.service " + serviceName + " is not found!");
        }
        ...
        detailView.put("com.yuanxiaoyuan.springcloudalibabafeign.service", serviceObject);
    ...
    @RequestMapping("/rt/com.yuanxiaoyuan.springcloudalibabafeign.service")
    public JSONObject rt4Service(HttpServletRequest request) {
        ...
        Service service = serviceManager.getService(namespaceId, serviceName);
        if (service == null) {
            throw new IllegalArgumentException("request com.yuanxiaoyuan.springcloudalibabafeign.service doesn't exist");
        }
