...
/**
 * A selector to implement a so called same-label-prior rule for com.yuanxiaoyuan.springcloudalibabafeign.service discovery.
 * <h2>Backgroup</h2>
 * Consider com.yuanxiaoyuan.springcloudalibabafeign.service providers are deployed in two sites i.e. site A and site B, and consumers
 * of this com.yuanxiaoyuan.springcloudalibabafeign.service provider are also deployed in site A and site B. So the consumers may want to
 * visit the com.yuanxiaoyuan.springcloudalibabafeign.service provider in current site, thus consumers in site A visit com.yuanxiaoyuan.springcloudalibabafeign.service providers
 * in site A and consumers in site B visit com.yuanxiaoyuan.springcloudalibabafeign.service providers in site B. This is quite useful to
