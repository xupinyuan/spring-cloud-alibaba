...
public class CatalogControllerTest {
    ...
    public void testServiceDetail() throws Exception {
        ...
        String result1 = mockmvc.perform(get(UtilsAndCommons.NACOS_NAMING_CONTEXT + "/catalog/com.yuanxiaoyuan.springcloudalibabafeign.service")
        ...
        JSONObject serviceResult = (JSONObject) result.get("com.yuanxiaoyuan.springcloudalibabafeign.service");
    ...
    public void testServiceDetailNotFound() throws Exception {
        String result = mockmvc.perform(get(UtilsAndCommons.NACOS_NAMING_CONTEXT + "/catalog/com.yuanxiaoyuan.springcloudalibabafeign.service")
            .param(CommonParams.NAMESPACE_ID, Constants.DEFAULT_NAMESPACE_ID)
            .param(CommonParams.SERVICE_NAME, TEST_SERVICE_NAME)).andReturn().getResponse().getContentAsString();

        Assert.assertTrue(result.contains("test-com.yuanxiaoyuan.springcloudalibabafeign.service is not found!"));
    }

    private static final String TEST_CLUSTER_NAME = "test-cluster";
    private static final String TEST_SERVICE_NAME = "test-com.yuanxiaoyuan.springcloudalibabafeign.service";
