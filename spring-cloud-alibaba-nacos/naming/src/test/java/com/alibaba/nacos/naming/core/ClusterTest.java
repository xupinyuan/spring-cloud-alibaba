...
public class ClusterTest {
    ...
    public void updateCluster() {
        Service service = new Service();
        service.setName("nacos.com.yuanxiaoyuan.springcloudalibabafeign.service.2");
    ...
    public void testValidate() {
        Service service = new Service("nacos.com.yuanxiaoyuan.springcloudalibabafeign.service.2");
        cluster = new Cluster("nacos-cluster-1", service);
        cluster.validate();
    }
